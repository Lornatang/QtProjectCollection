...
TitleBar::TitleBar(QWidget *parent) : QWidget(parent) {
  ...
  connect(minToolButton, &QToolButton::clicked, this->window(),
  ...
  connect(maxToolButton, &QToolButton::clicked, this,
          &TitleBar::toggleMaxState);
  ...
  connect(closeToolButton, &QToolButton::clicked, this->window(),
          &QWidget::close);
...
void TitleBar::mouseDoubleClickEvent(QMouseEvent *event) { toggleMaxState(); }
